...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="<?= base_url('public'); ?>/assets/extra-libs/multicheck/multicheck.css"
    />
    <link
      href="<?= base_url('public'); ?>/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css"
      rel="stylesheet"
    />
    <link href="<?= base_url('public'); ?>/dist/css/style.min.css" rel="stylesheet" />
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="<?= base_url('public'); ?>/assets/images/logo-icon.png"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="<?= base_url('public'); ?>/assets/images/logo-text.png"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
